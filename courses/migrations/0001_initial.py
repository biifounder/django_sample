    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=400)),
                ('content', models.CharField(default='_', max_length=10000)),
                ...
                ('s', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='courses.subject')),
            ],
        ),
        migrations.CreateModel(
            name='OutcomeEval',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(null=True, upload_to='')),
                ('ansimg', models.FileField(null=True, upload_to='')),
                ('video', embed_video.fields.EmbedVideoField(null=True)),
                ('source', models.CharField(default='other', max_length=400)),
                ('kind', models.CharField(default='understand', max_length=400)),
                ('k', models.CharField(default='1', max_length=400)),
                ('p', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.outcome')),
                ('y', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='courses.year')),
            ],
        ),
        migrations.CreateModel(
            name='QEval',
        ...
        migrations.AddField(
            model_name='outcome',
            name='u',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='courses.unit'),
        ),
        migrations.AddField(
            model_name='lesson',
            name='p',
        ...
        migrations.AddField(
            model_name='outcome',
            name='y',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='courses.year'),
        ),
        migrations.AddField(
            model_name='lesson',
            name='y',
